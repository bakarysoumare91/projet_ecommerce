			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-3 col-xs-6">
						...
						<div class="product">
							<div class="product-img">
								<img src="{{asset('storage/'.$catProduc->photo_second)}}" alt=""> <!-- ici on a fait la concatenation dans on a recuperer cheminement dans la base pui concatené avec  le repertoir storage-->
